        ...
        <div class="block">
            ...
            <div class="block-content collapse in">
                <div class="span12">
                    <table class="table table-striped table-hover">
                        ...
                        @if(!empty($cart_items))
                            ...
                            <tr>
                                ...
                                @endif
                                <td class="span5">
                                    <a href="{{ url('product').'/'.$item->model->id }}">{{ $item->name }}</a>
                    ...
                    <div class="row-fluid">
                        <div class="span6"></div>
                        <div class="span6"><b>Total: {{ $total }}</b></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="span12">
                        ...
                        <form class="form-horizontal">
                          <div class="control-group">
                                ...
                                <input value="{{ Auth::user()->email }}" type="text" id="email" value="" placeholder="Email Address">
                          </div>

                          <div class="control-group">
                                <label for="name">Name <span class="text-error">*</span></label>
                                <input value="{{ Auth::user()->name }}"  type="text" id="name" value="" placeholder="Full Name">
                          </div>
